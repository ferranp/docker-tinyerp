...
##############################################################################
"""
  Llistat de Tarifes de tractament
...
<form string="Llistat de Tarifes de Tractament">
...
class wizard_report(wizard.interface):
    ...
    def _select_pricelist(self, cr, uid, data, context):
        ...
        ids = pool.get('pricelist.kilo').search(cr,uid,[])
    ...
    states = {
        ...
        'report': {
            ...
            'result': {'type':'print', 
            'report':'carreras.pricelist_tr_report', 
            'get_id_from_action':True ,
            'state':'end'}
        }
    }
wizard_report('carreras.pricelist_tr_report')
